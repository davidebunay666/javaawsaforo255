pipeline {
    ...
    stages {
        stage('SCM') {
            steps {
               git branch: 'main', url: 'https://github.com/davidebunay666/javaawsaforo255'
            }
        }
    ...
    stage ("Docker Build") {
           ...
           steps{
             // docker login  
             bat(script: 'docker build -t davidbunay66/javaaforo255:latest .' , returnStdout:true);
             bat(script: 'docker push davidbunay66/javaaforo255:latest' , returnStdout:true);  
           }
       }
